...
class _SkillPageState extends State<SkillPage> {
  bool isapp = false,
      ...
      isit = false,
      isui = false;
  final onHoverActive = Matrix4.identity()..translate(0, -10.0, 0);
            ...
            children: [
              ...
              InkWell(
                  ...
                  child: BuildAnimatedContainer(
                      ...
                      text:"It can be used to develop web and mobile apps as well as server and desktop applications. Dart. Paradigm. Multi-paradigm: functional, imperative, object-oriented, reflective.",
                      hover: isweb)),
              SizedBox(
                width: 20,
              ),
              InkWell(
                  ...
                  child: BuildAnimatedContainer(
                      ...
                      icon: Icons.web,
                      text:"Displaying your programming skills and web development experience is key. It is also a good idea to mention the education or web development certifications you've earned to add credibility. Curate your projects. Display only your best work.",
                      hover: isgraphic)),
            ],
          ),
        ),
